...
export class AppointmentService {
  ...
  async fetchById(appointmentId: number): Promise<Omit<AppointmentData, 'lastModificationDate'>> {
    ...
    const appointmentData = await this.appointmentDao.fetchById(appointmentId, this.jwtPayload.userId);
  ...
  async validateAppointment(
    ...
    const appointment = await this.appointmentDao.fetchById(appointmentId, this.jwtPayload.userId);
